...
Select what you want to edit:`;
    ...
    static confirmDeleteService(service) {
...
Example: 8445`;
    ...
    static createServerStep6() {
        return `✅ Step 6/11

Please enter the *API token*:`;
    }
    static createServerStep7() {
        return `✅ Step 7/11
...
Example: 200`;
    ...
    static createServerStep8() {
        return `✅ Step 8/11

Please enter the *server location*:
Example: Germany`;
    }
    static createServerStep9() {
        return `✅ Step 9/11
...
Select what you want to edit:`;
    ...
    static confirmDeleteServer(server) {
...
• This action cannot be undone`;
    ...
    // ============ STATISTICS ============
    static statsOverview(userStats, paymentStats, serverStats, activeConfigs, expiringCount) {
...
• Expiring Soon (3 days): ${expiringCount}`;
    ...
    static paymentsList(payments, stats) {
